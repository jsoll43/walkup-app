...
- Year-over-year reporting defaults to fiscal year to date, comparing the same fiscal months in each year. A separate full-fiscal-year view compares all recorded activity and clearly labels the current year's latest recorded month when that year is still incomplete.
